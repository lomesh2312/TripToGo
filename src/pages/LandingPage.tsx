    ...
    <div className="min-h-screen bg-cream-200">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 pt-10 pb-0">
          <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-6 gap-4">
            ...
            <div className="flex flex-col items-start md:items-end justify-end gap-3 md:pt-4">
              ...
              <Link
                to={user ? '/plan' : '/signup'}
                className="flex items-center space-x-1 text-xs font-medium text-forest-500 uppercase tracking-widest border-b border-forest-500 pb-0.5 hover:text-forest-600 group"
              >
      ...
      <section id="services" className="max-w-7xl mx-auto px-6 lg:px-10 py-16 mt-8">
        <div className="text-center mb-10">
          <p className="text-[10px] font-medium text-olive-400 uppercase mb-2">Services</p>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-10 py-20 text-center">
        ...
        <Link
          to={user ? '/plan' : '/signup'}
          className="inline-flex items-center space-x-2 bg-forest-500 text-cream-100 px-8 py-3.5 text-sm font-medium hover:bg-forest-400 transition-colors duration-200 rounded-sm"
        >
...
const SERVICES = [
  {
    ...
    tag: 'As You Wish',
    heading: <>Tailored <em>AI Plans</em><br />in Seconds</>,
    description: 'Enjoy a personalized itinerary powered by advanced AI. These plans offer complete flexibility — visit as many or as few places as you wish, all at your own pace.',
  ...
  },
  {
    ...
    tag: 'Save Smart',
    heading: <>Affordable <em>Adventures</em><br />for Everyone</>,
    description: 'Explore the world without breaking the bank. Our budget plans find the best value hotels, transport, and activities so you can travel more for less.',
  ...
  },
  {
    ...
    tag: 'Premium',
    heading: <>First-Class <em>Luxury</em><br />Experiences</>,
    description: 'Indulge in premium hotels, private transfers, and exclusive venues. We handle every detail so you can focus entirely on the experience.',
  ...
  },
  {
    ...
    label: 'Group Tours',
    tag: 'Together',
    heading: <>Memorable <em>Group</em><br />Adventures</>,
    description: 'We coordinate multi-person trips so everyone travels together seamlessly. From family reunions to friend getaways — we manage the complexity.',
    badge: 'Perfect for families and friend groups.',
    image: 'https://images.pexels.com/photos/1371360/pexels-photo-1371360.jpeg',
  },
];

function ServicesGrid({ user }: any) {
      ...
      <div className="flex flex-col gap-2">
        {SERVICES.map((s) => (
          <button
            ...
            className={`text-left px-5 py-3.5 text-sm font-medium transition-all duration-200 rounded-sm border ${active === s.key ? 'bg-forest-500 text-cream-100 border-forest-500' : 'bg-cream-100 text-olive-600 border-cream-400 hover:border-forest-300 hover:text-forest-500'}`}
          >
            {s.label}
          </button>
        ))}
